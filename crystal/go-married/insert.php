...
//var_dump($_POST); die();
	 ...
	 $sql = "
	 INSERT INTO
	 	data_jenazah(nama_jenazah, NIK, alamat, tempat_lahir, tanggal_lahir, jenis_kelamin, tgl_pemakaman, ID_TPU)
	 VALUES(
	 	'".$_POST["nama_jenazah"]."',
	 	'".$_POST["NIK"]."',
	 	'".$_POST["alamat"]."',
	...
	if(mysqli_query($connect, $sql)){
	 	$sql2= "INSERT INTO data_ahli_waris(ID_JENAZAH,nama_ahli_waris, NIK_w, alamat_w, tempat_lahir_w, tanggal_lahir_w, no_telp, jenis_kelamin_w, tanggal_sewa)
	 		VALUES(
